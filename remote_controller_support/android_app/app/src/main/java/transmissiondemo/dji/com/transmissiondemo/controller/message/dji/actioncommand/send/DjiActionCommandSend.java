...
public abstract class DjiActionCommandSend extends SendDjiMessage<msg_dji_action_command> {

    private final short targetSystem;
    private final int action;

    DjiActionCommandSend(final short targetSystem, final int action, final Runnable onSuccessCallback, final Runnable onFailureCallback) {
