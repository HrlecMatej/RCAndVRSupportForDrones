...
public abstract class PoseStampedSend extends SendDjiMessage<msg_dji_pose_stamped> {
    ...
    PoseStampedSend(final short targetSystem, final int topicName, final double[] position, final double[] orientation, final Runnable onSuccessCallback, final Runnable onFailureCallback) {
